                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" required name="number" value="5">
                        </div>
                        <div class="form-group">
                            <label for="">Giá bán</label>
                            <input type="number" class="form-control" required name="price" value="300000">
                        </div>
                        <div class="form-group">
                            <label for="">Giá khuyến mãi</label>
                            <input type="number" class="form-control" required name="pricesale" value="0">
                        </div>
                        <div class="form-group">
