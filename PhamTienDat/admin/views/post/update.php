...
foreach ($list_topic as $item) {
    if ($item['id'] == $row['topid']) {
        $str_toptid .= "<option selected value='" . $item['id'] . "'>" . $item['name'] . "</option>";
    } else {
...
<form action="index.php?option=post&cat=process&id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
